...
class GUI(RA_UI_GUI):
    ...
    def read_config(self):
        ...
        file = '/dls/science/groups/i04/Python/applications/beamline_setup/modules/AlignBeam/AlignBeam.yaml'
        self.config = {}
    ...
    def retranslateUi(self, RemoteAccess_WZ):
        ...
        RemoteAccess_WZ.setWindowTitle(_translate("RemoteAccess_WZ", "Align Beam Module"))
